		...
		<div className={styles.mainContainer}>
			...
			<div className={styles.inputContainer}>
				<PhoneInput
					...
					setValue={(val) =>
						setUserDetails((u) => ({ ...u, phone_number: val }))
					}
				/>
				<PasswordInput
					value={userDetails.password}
					setValue={(val) => setUserDetails((u) => ({ ...u, password: val }))}
				/>
				<TextInput
					placeholder={"Full Name"}
					value={userDetails.name}
					setValue={(val) => setUserDetails((u) => ({ ...u, name: val }))}
				/>
				<TextInput
					placeholder={"Address"}
					value={userDetails.address}
					setValue={(val) => setUserDetails((u) => ({ ...u, address: val }))}
				/>
			</div>
			<Checkboxes
				isCollector={userDetails.isCollector}
				setValue={(val) => setUserDetails((u) => ({ ...u, isCollector: val }))}
			/>
